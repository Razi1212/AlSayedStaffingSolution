      ...
      <div className="bg-stone-200">
        <div className="lg:mx-20 mx-5 py-6">
          ...
          <div className="text-black ">
            ...
            <div className="lg:flex gap-20 lg:m-9 ">

              <div className="bg-white pb-10 rounded-2xl shadow-lg  sm:w-[300px] sm:mb-10">
              <img src="./construction.jpg" alt="Sample" className="w-full object-cover rounded-b-[100px] rounded-lg " />
                <h3 className="text-lg font-semibold my-4 px-10 ">Hi-Tech</h3>
                <ul className="space-y-2 text-sm px-10">
              ...
              <div className="bg-white pb-10 rounded-2xl shadow-lg w-full sm:w-[300px] sm:mb-10">
              <img src="./construction.jpg" alt="Sample" className="w-full object-cover rounded-b-[100px] rounded-lg " />
                <h6 className="text-lg font-semibold my-4 px-10"> Banking & Finance</h6>
                <ul className="space-y-2 text-sm px-10">
              ...
              <div className="bg-white pb-10 rounded-2xl shadow-lg w-full sm:w-[300px] sm:mb-10">
              <img src="./construction.jpg" alt="Sample" className="w-full object-cover rounded-b-[100px] rounded-lg " />
                <h6 className="text-lg font-semibold my-4 px-10 ">Retail & E-commerce</h6>
                <ul className="space-y-2 text-sm px-10">
            ...
            <div className="bg-white pb-10 rounded-2xl shadow-lg w-full sm:w-[300px] sm:mb-10">
              <img src="./construction.jpg" alt="Sample" className="w-full object-cover rounded-b-[100px] rounded-lg " />
                <h6 className="text-lg font-semibold my-4 px-10 ">Consumer Electronics</h6>
                <ul className="space-y-2 text-sm px-10">
                  <li>✔️ Networking</li>
                  <li>✔️ Embedded</li>
              ...
              <div className="bg-white pb-10 rounded-2xl shadow-lg w-full sm:w-[300px] sm:mb-10">
              <img src="./construction.jpg" alt="Sample" className="w-full object-cover rounded-b-[100px] rounded-lg " />
                <h6 className="text-lg font-semibold my-4 px-10 ">Automotive and Manufacturing</h6>
                <ul className="space-y-2 text-sm px-10">
