        ...
        <div className="lg:mx-20 mx-5 py-6">
          ...
          <div className="text-black ">
            ...
            <div className="lg:flex gap-20 m-9">
              ...
              <div className="border-red-500 border-2 pb-10 rounded-lg shadow-md w-full sm:w-[300px] hover:bg-red-500 hover:text-white">
              ...
              <div className=" border-blue-500 border-2 pb-10 rounded-lg shadow-md w-full sm:w-[300px] hover:bg-blue-500 hover:text-white">
              <img src="./construction.jpg" alt="Sample" className="w-full object-cover rounded-b-[100px] rounded-lg " />
              ...
              <div className=" border-yellow-500 border-2 pb-10 rounded-lg shadow-md w-full sm:w-[300px] hover:bg-yellow-500 hover:text-white" >
              <img src="./construction.jpg" alt="Sample" className="w-full object-cover rounded-b-[100px] rounded-lg " />
            ...
            <div className="lg:flex gap-20 m-9">
              ...
              <div className=" border-green-500 border-2 pb-10 rounded-lg shadow-md w-full sm:w-[300px] hover:bg-bg:green-500 hover:text-white ">
              <img src="./construction.jpg" alt="Sample" className="w-full object-cover rounded-b-[100px] rounded-lg " />
              ...
              <div className="border-amber-500 border-2 pb-10  rounded-lg shadow-md w-full sm:w-[300px] hover:bg-amber-500 hover:text-white">
              <img src="./construction.jpg" alt="Sample" className="w-full object-cover rounded-b-[100px] rounded-lg " />
                <h6 className="text-lg font-semibold mb-4">Consumer Electronics</h6>
                <ul className="space-y-2 text-sm">
                  <li>✔️ Networking</li>
              ...
              <div className="border-teal-500 border-2 pb-10  rounded-lg shadow-md w-full sm:w-[300px] hover:bg-teal-500 hover:text-white">
              <img src="./construction.jpg" alt="Sample" className="w-full object-cover rounded-b-[100px] rounded-lg " />
