  ...
  return (
    <>
      ...
      <div className="w-full bg-white">
        <div className="bg-BgColor-homecolor min-h-screen w-full lg:max-w-[1400px] mx-auto lg:px-[8%] lg:py-10 p-5">
          {/* ///bg-BgColor-homecolor min-h-screen w-full lg:px-[8%] lg:py-10 p-5 */}
          <div className="lg:flex gap-10 items-center justify-center">
            <motion.div
              ref={ref1}
              variants={fadeScale}
            ...
            <motion.div
              ...
              className="flex-1 space-y-4"
            >
              <h6 className="text-3xl font-bold text-gray-900 mt-6">
              ...
              <p className="my-5 inline-flex items-start text-base">
                <span>
                  In today's competitive market, finding the right talent or the
                  perfect career opportunity is crucial. Al Sayed Staffing
                  Solutions, established in 2023, is your trusted partner in
                  navigating this landscape. We bring together a team of highly
              ...
              <p className="mb-5 inline-flex items-start text-base">
                <span>
                  Precision Matching: Our in-depth understanding of diverse
                  industries allows us to meticulously align candidate skills and
                  experience with your specific job requirements.
                  Efficiency Through Automation: Our fully automated system and
                  streamlined procedures ensure a seamless and efficient hiring
                  process, saving you time and resources.
                  Quality Assurance: We are committed to delivering only top-tier
                  candidates, ensuring they can immediately contribute to your
                  organization's success. For Candidates: Build Your Dream
                  Career.
                </span>
              </p>
              ...
              <p className="mb-5 inline-flex items-start text-base">
                <span>
                  Access to Premier Opportunities: We connect you with leading
                  multinational companies and diverse industrial sectors across
                  the GCC. Career Growth Support: We are dedicated to supporting
                  your professional development, helping you achieve your career
                  aspirations. Personalized Matching: We take the time to
                  understand your skills and experience, ensuring you are matched
                  with roles that are the perfect fit.
                </span>
              </p>
            </motion.div>
          </div>
          ...
          <section className="bg-BgColor-homecolor lg:mt-[8%]">
            ...
            >
              ...
              <p className="text-center text-gray-900 max-w-3xl mx-auto text-xl">
                Professional business advice and support are essential for
                addressing challenges and capitalizing on opportunities at any
                stage of a business's lifecycle. From foundational planning for
                startups to strategic realignment for established companies,
                expert consultants can help identify and implement impactful
                solutions.
              </p>

              <motion.div
                className="p-6 lg:p-20 rounded-xl lg:flex lg:gap-10 space-y-6 lg:space-y-0"
              ...
              >
                {[
                  ...
                  <motion.div
                    key={index}
                    className="flex-1 space-y-4 text-black flex flex-col items-center"
                    variants={fadeScale}
                  >
                    <FaCheckDouble className="ml-2" size={30} />
                    <h3 className="text-xl font-semibold text-center">{item.title}</h3>
                    <span className="text-center text-base">{item.desc}</span>
                  </motion.div>
                ))}
              </motion.div>
            </motion.div>
